    ...
    <div className="mt-20 flex scale-125 items-center justify-center rounded-lg bg-white p-10 shadow-lg">
      <div className="flex flex-col">
        <div className="flex flex-row">
          <h2 className="text-2xl font-medium text-blue-500">{cityData.name}</h2>
        ...
        <div className="flex flex-row justify-center gap-20">
          <div className="flex flex-col">
            <div className="flex flex-row items-center gap-5">
              <img src={cityData.iconURL} alt="weather icon" className="w-20" />
          ...
          <table className="w-1/2 text-blue-400">
            <tbody>
              <tr>
                <td>Wind:</td>
                <td className="text-right">{cityData.details.wind} km/h</td>
              </tr>
              <tr>
                <td>Humidity:</td>
                <td className="text-right">{cityData.details.humidity}%</td>
              </tr>
              <tr>
                <td>Condition:</td>
                <td className="text-right">{cityData.details.condition}</td>
              </tr>
            </tbody>
          </table>
        </div>
