            ...
            <div class="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('plants.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="spot" class="mt-1 block w-full" type="text" name="spot" :value="old('spot')" required />
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('plants.index') }}" class="text-sm text-gray-600 underline hover:text-gray-900">{{ __('Cancel') }}</a>
                    </div>
                </form>
            </div>
        </div>
