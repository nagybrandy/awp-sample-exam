        ...
        <div class="flex h-16 justify-between">
            <div class="flex">
                <div class="flex shrink-0 items-center">
                    <a href="{{ auth()->check() ? route('dashboard') : route('home') }}" class="flex items-center gap-2 text-lg font-semibold tracking-tight text-emerald-800">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        <x-nav-link :href="route('plants.mine')" :active="request()->routeIs('plants.mine')">
                            {{ __('My plants') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="space-y-1 pb-3 pt-2">
            @auth
                ...
                <x-responsive-nav-link :href="route('plants.mine')" :active="request()->routeIs('plants.mine')">
                    {{ __('My plants') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('plants.create')" :active="request()->routeIs('plants.create')">
                    {{ __('Add plant') }}
                </x-responsive-nav-link>
            @else
                <x-responsive-nav-link :href="route('plants.index')" :active="request()->routeIs('plants.index')">
